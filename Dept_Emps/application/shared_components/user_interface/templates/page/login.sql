...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(117785353845827253049)
,p_theme_id=>42
,p_name=>'Login'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(117785354193437253050)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(117785354449084253050)
,p_page_template_id=>wwv_flow_imp.id(117785353845827253049)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(117785354706238253050)
,p_page_template_id=>wwv_flow_imp.id(117785353845827253049)
,p_name=>'Body Header'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(117785355033357253050)
,p_page_template_id=>wwv_flow_imp.id(117785353845827253049)
,p_name=>'Body Footer'
