...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(117785455695510253100)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(117785455989330253100)
,p_plug_template_id=>wwv_flow_imp.id(117785455695510253100)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(117785456222832253100)
,p_plug_template_id=>wwv_flow_imp.id(117785455695510253100)
,p_name=>'Tabs'
