...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(117785463423391253103)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(117785463713933253104)
,p_plug_template_id=>wwv_flow_imp.id(117785463423391253103)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(117785464052477253104)
,p_plug_template_id=>wwv_flow_imp.id(117785463423391253103)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(117785464352241253104)
,p_plug_template_id=>wwv_flow_imp.id(117785463423391253103)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(117785464628080253104)
,p_plug_template_id=>wwv_flow_imp.id(117785463423391253103)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(117785464907620253104)
,p_plug_template_id=>wwv_flow_imp.id(117785463423391253103)
