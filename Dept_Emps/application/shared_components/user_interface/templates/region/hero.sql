...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(117785412465089253079)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(117785412705276253080)
,p_plug_template_id=>wwv_flow_imp.id(117785412465089253079)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(117785413050451253080)
,p_plug_template_id=>wwv_flow_imp.id(117785412465089253079)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(117785413343714253080)
,p_plug_template_id=>wwv_flow_imp.id(117785412465089253079)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(117785413637225253080)
,p_plug_template_id=>wwv_flow_imp.id(117785412465089253079)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(117785413960917253080)
,p_plug_template_id=>wwv_flow_imp.id(117785412465089253079)
,p_name=>'Up'
,p_placeholder=>'UP'
,p_has_grid_support=>false
