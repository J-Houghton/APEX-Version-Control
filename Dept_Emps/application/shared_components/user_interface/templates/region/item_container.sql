...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(117785438053946253091)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(117785438300650253091)
,p_plug_template_id=>wwv_flow_imp.id(117785438053946253091)
,p_name=>'Item'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(117785438691200253091)
,p_plug_template_id=>wwv_flow_imp.id(117785438053946253091)
,p_name=>'Button End'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(117785438994511253092)
,p_plug_template_id=>wwv_flow_imp.id(117785438053946253091)
,p_name=>'Button Start'
