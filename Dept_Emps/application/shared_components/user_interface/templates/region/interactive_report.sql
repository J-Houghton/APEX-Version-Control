...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(117785435953917253090)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(117785436237221253090)
,p_plug_template_id=>wwv_flow_imp.id(117785435953917253090)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(117785436537974253090)
,p_plug_template_id=>wwv_flow_imp.id(117785435953917253090)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(117785436875733253090)
,p_plug_template_id=>wwv_flow_imp.id(117785435953917253090)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(117785437173940253090)
,p_plug_template_id=>wwv_flow_imp.id(117785435953917253090)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(117785437401102253090)
,p_plug_template_id=>wwv_flow_imp.id(117785435953917253090)
,p_name=>'Sub Regions'
