...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(117785443000422253094)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(117785443304364253094)
,p_plug_template_id=>wwv_flow_imp.id(117785443000422253094)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(117785443667140253094)
,p_plug_template_id=>wwv_flow_imp.id(117785443000422253094)
,p_name=>'Search Field'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(117785443905811253094)
,p_plug_template_id=>wwv_flow_imp.id(117785443000422253094)
,p_name=>'Sub Regions'
