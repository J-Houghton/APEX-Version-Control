...
,p_group_id=>wwv_flow_imp.id(117785906054176254086)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(117785907643279254088)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(117785907973556254088)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(117785907294771254087)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(117785908458373254088)
,p_name=>'P20010_ENABLE_PUSH'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(117785907973556254088)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(117785908758886254088)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(117785909224414254089)
,p_event_id=>wwv_flow_imp.id(117785908758886254088)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(117785909795593254089)
,p_event_id=>wwv_flow_imp.id(117785908758886254088)
