...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(117785379126932253063)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(117785379478558253063)
,p_plug_template_id=>wwv_flow_imp.id(117785379126932253063)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(117785379789807253063)
,p_plug_template_id=>wwv_flow_imp.id(117785379126932253063)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(117785380072923253063)
,p_plug_template_id=>wwv_flow_imp.id(117785379126932253063)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(117785380321418253063)
,p_plug_template_id=>wwv_flow_imp.id(117785379126932253063)
,p_name=>'Sub Regions'
