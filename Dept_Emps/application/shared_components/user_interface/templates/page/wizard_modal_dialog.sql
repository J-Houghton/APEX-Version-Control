...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(117785372436036253059)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(117785372765306253059)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(117785373047534253059)
,p_page_template_id=>wwv_flow_imp.id(117785372436036253059)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(117785373331318253060)
,p_page_template_id=>wwv_flow_imp.id(117785372436036253059)
