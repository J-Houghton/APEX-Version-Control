...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(117785363854598253054)
,p_theme_id=>42
,p_name=>'Modal Dialog'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(117785364184382253055)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(117785364486334253055)
,p_page_template_id=>wwv_flow_imp.id(117785363854598253054)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(117785364758230253055)
,p_page_template_id=>wwv_flow_imp.id(117785363854598253054)
