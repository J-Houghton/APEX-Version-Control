...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(117785440569172253092)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(117785440869020253092)
,p_plug_template_id=>wwv_flow_imp.id(117785440569172253092)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(117785441186323253093)
,p_plug_template_id=>wwv_flow_imp.id(117785440569172253092)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(117785441408745253093)
,p_plug_template_id=>wwv_flow_imp.id(117785440569172253092)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(117785441721598253093)
,p_plug_template_id=>wwv_flow_imp.id(117785440569172253092)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(117785442061142253093)
,p_plug_template_id=>wwv_flow_imp.id(117785440569172253092)
,p_name=>'Sub Regions'
