...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(117785386289618253066)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(117785386540692253067)
,p_plug_template_id=>wwv_flow_imp.id(117785386289618253066)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(117785386863030253067)
,p_plug_template_id=>wwv_flow_imp.id(117785386289618253066)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(117785387188527253067)
,p_plug_template_id=>wwv_flow_imp.id(117785386289618253066)
,p_name=>'Sub Regions'
