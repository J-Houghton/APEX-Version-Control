...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(117785911275413254090)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(117785911592791254090)
,p_plug_name=>'&APP_USER.'
,p_region_template_options=>'#DEFAULT#:t-CardsRegion--styleB'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(117785386289618253066)
...
wwv_flow_imp_page.create_card(
 p_id=>wwv_flow_imp.id(117785912058828254091)
,p_region_id=>wwv_flow_imp.id(117785911592791254090)
,p_layout_type=>'ROW'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(117785912528406254091)
...
,p_list_id=>wwv_flow_imp.id(117785910189830254089)
