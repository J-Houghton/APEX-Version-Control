...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(117785380575384253064)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(117785380887213253064)
,p_plug_template_id=>wwv_flow_imp.id(117785380575384253064)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(117785381169295253064)
,p_plug_template_id=>wwv_flow_imp.id(117785380575384253064)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(117785381474899253064)
,p_plug_template_id=>wwv_flow_imp.id(117785380575384253064)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(117785381758463253064)
,p_plug_template_id=>wwv_flow_imp.id(117785380575384253064)
,p_name=>'Sub Regions'
