...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(117785415957935253081)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(117785416221883253081)
,p_plug_template_id=>wwv_flow_imp.id(117785415957935253081)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(117785416553797253081)
,p_plug_template_id=>wwv_flow_imp.id(117785415957935253081)
,p_name=>'Sub Regions'
