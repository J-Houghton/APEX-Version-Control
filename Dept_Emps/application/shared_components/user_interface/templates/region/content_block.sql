...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(117785407876549253077)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(117785408142689253077)
,p_plug_template_id=>wwv_flow_imp.id(117785407876549253077)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(117785408469056253077)
,p_plug_template_id=>wwv_flow_imp.id(117785407876549253077)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(117785408776402253078)
,p_plug_template_id=>wwv_flow_imp.id(117785407876549253077)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(117785409057244253078)
,p_plug_template_id=>wwv_flow_imp.id(117785407876549253077)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(117785409378814253078)
,p_plug_template_id=>wwv_flow_imp.id(117785407876549253077)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(117785409632289253078)
,p_plug_template_id=>wwv_flow_imp.id(117785407876549253077)
,p_name=>'Sub Regions'
